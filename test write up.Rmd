...
#  mutate(v004_other_data_1 = 1/ v004_other_data_1) %>%
#filter(!is.na(v004_other_data_1) & !is.na(v062_other_data_1) & state != "US")  %>% 
group_by(state) 
>>>>>>> bb918b770ab4321017a8477b9c42cd32c2e4c78d
...
n_color_dim = 2
data_bi1 = bi_class(bi_chloro, x = v005_rawvalue, y = v004_rawvalue, style = "quantile", dim = n_color_dim)
...
#data_bi1 =  data_bi1
#%>% 
#  rename(biVar = bi_class)
#  mutate(biVar = bi_class) %>% 
#  select(-(1:4)) %>% 
#  select(-bi_class)
  
#data_bi1$bi_class = rep("3-3", nrow(data_bi1))
#join two dataframes
...
#description[["v004_other_data_1"]] = "PCP Ratio"#"Population / PCPs."
map <- ggplot() +
...
=======
                    dim = n_color_dim,
                    xlab = sub(" raw value", "", description[["v005_rawvalue"]]),
                    ylab = sub(" raw value", "", description[["v004_rawvalue"]]),
>>>>>>> bb918b770ab4321017a8477b9c42cd32c2e4c78d
                    size = 5)
